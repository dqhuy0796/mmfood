    ...
    render() {
        return (
            <div className={scss('background')}>
                ...
                <svg aria-labelledby="Starry sky" alt="Starry sky" className={scss('starry-sky')}>
                    <title id="copyright-title">powered by Dqhuy</title>
                    <g className={scss('all-stars')} fill="#F6F5BC">
                        <path
                            className={scss('stars-one')}
