        ...
        return (
            <div className={cb('background')}>
                <div className={cb('content')}>
                    ...
                    <Button className={cb('btn')} size={'large'} shape={'pill'} color={'white'} to={config.routes.home}>
                        Trở về trang chủ
                    </Button>
                </div>

                <svg aria-labelledby="Starry sky" alt="Starry sky" className={cb('starry-sky')}>
                    <title id="copyright-title">powered by Dqhuy</title>
                    <g className={cb('all-stars')} fill="#F6F5BC">
                        <path
                            className={cb('stars-one')}
