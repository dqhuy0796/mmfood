...
import styles from './CheckoutPaymentDetail.module.scss';

const scss = classNames.bind(styles);

class CheckoutPaymentDetail extends React.Component {
    state = {
        dialog: {
            active: false,
        },
            ...
            <div className={scss('wrapper')}>
                ...
                <div className={scss('summary')}>
                    ...
                    {this.props.cart.subtotal > 0 && (
                        <Button size={'full'} color={'primary'} onClick={() => this.props.handleCheckOut()}>
                            <span>Đặt hàng</span>
                        </Button>
                    )}
                </div>
...
export default connect(mapStateToProps, mapActionsToProps)(CheckoutPaymentDetail);
